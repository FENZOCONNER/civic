...
def menu():
	...
	print(h+line)
	print(h+"\n{"+k+"01"+h+"}"+l+" Crack Dari Pertemanan Publik")
	print(h+"{"+k+"02"+h+"}"+l+" Crack Dari Followers Publik")
	print(h+"{"+k+"03"+h+"}"+l+" Crack Pertemanan Publik "+k+"{"+h+"Massal"+k+"}")
	print(h+"{"+k+"04"+h+"}"+l+" Crack Akun Old 04/08 "+k+"{"+h+"Massal"+k+"}")
	print(h+"{"+k+"05"+h+"}"+l+" Crack Akun Old 04/10 "+k+"{"+h+"Massal"+k+"}")
	print(h+"{"+k+"06"+h+"}"+l+" Setting User Agent")
	print(h+"{"+k+"07"+h+"}"+l+" Cek Opsi Hasil Crack")
	print(h+"{"+k+"08"+h+"}"+l+" Cek Result Crack")
	print(h+"{"+k+"09"+h+"}"+l+" Setting Tema")
	print(h+"{"+k+"10"+h+"}"+l+" Join Grup "+k+"{"+h+"XNX-CODE"+k+"}")
	print(h+"{"+k+"11"+h+"}"+l+" Info SC")
	print(h+"{"+k+"00"+h+"}"+l+" Logout "+k+"{"+m+"hapus token"+k+"}")
	sayangku = input("\n"+balmond+l+" Pilih : ")
...
def info():
	print(u+line)
	print(h+"["+k+" Info Created and Team "+h+"]")
	print(u+line)
	print(h+"["+k+" Created Script "+h+"]")
	print(p+" • "+h+"YumasaaTzy")
	print(p+" • "+h+"Fenz O. Conner")
	print(p+" • "+h+"EzaaSoftBoy")
	print(p+" • "+h+"Yogzz")
	print(p+" • "+h+"Ditzy")
	print(p+line)
	print(h+"["+k+" Team Script "+h+"]")
	print(p+" • "+h+"Ang-Cyber")
	print(p+" • "+h+"Faiss Ganss")
	print(p+" • "+h+"Yumaa")
	print(p+" • "+h+"Mbokey Bhizer")
	print(p+" • "+h+"Alpinn")
	print(p+" • "+h+"Jarr-XD")
	print(p+" • "+h+"Indraa")
	print(p+" • "+h+"Hikmatt")
	...
	print(p+" • "+h+"Rafii-XD")
	print(p+line)
	print(h+"["+k+" Please Support and Follow Me!! "+h+"]")
	print(h+"["+k+" Thanks You "+h+"]")
	sayangku = input("\n"+balmond+l+" [Tekan Enter Untuk Ke Menu] ")
	menu()
...
def join():
    os.system("clear")
    banner()
    input("\n"+balmond+" Join Grup?(yes/no): ")
    jalan("\n"+balmond+" Join...Anda Akan Diarahkan Ke WhatsApp")
...
def user_agent():
	...
	if pilih=="1" or pilih=="01":
		...
		user = "Mozilla/5.0 (Linux; Android 4.1.2; Nokia_X Build/JZO54K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/30.0.1599.82 Mobile Safari/537.36 NokiaBrowser/1.2.0.11"
		tulis = open("user.txt","w");tulis.write(user);tulis.close()
		jalan("\n"+balmond+l+" Berhasil")
		time.sleep(0.5)
		menu()
...
def publik():
	try:
		...
		time.sleep(0.5)
		login()
	uid = input("\n"+balmond+l+" Masukan ID Target : ")
	try:
		asu = requests.get("https://graph.facebook.com/"+uid+"?access_token="+token)
		tulul = json.loads(asu.text)
		print(balmond+l+" Nama FB Target : "+tulul["name"])
	except KeyError:
		print(balmond+m+" ID Salah")
		time.sleep(0.5)
		publik()
	...
	if len(berapa_d)==0:
		...
		for angka in berapa_d:
			...
			if dutt>3599:
				...
				dett = ditt[0]+"d"
	print(h+"\r{"+k+"FOC"+h+"} "+l+"%s/%s OK:%s CP:%s %s[%s%s%s] [%s%s%s]"%(loop,len(id),len(ok),len(cp),h,k,persen,h,k,dett,h), end=' ');sys.stdout.flush()
